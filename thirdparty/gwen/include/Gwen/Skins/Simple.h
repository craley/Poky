...
namespace Gwen
{
    namespace Skin
    {
        ...
        public:
            ...
            Simple(Gwen::Renderer::Base* renderer)
            ...
            virtual void DrawWindow(Gwen::Controls::Base* control, int topHeight, bool inFocus)
            {
                ...
                m_Render->DrawFilledRect(Gwen::Rect(rect.x+rect.w-iBorderSize, rect.y+topHeight-1,
                                                    iBorderSize, rect.h-2-topHeight));
                m_Render->DrawFilledRect(Gwen::Rect(rect.x+1, rect.y+rect.h-iBorderSize,
                                                    rect.w-2, iBorderSize));
                // Main inner
                m_Render->SetDrawColor(Gwen::Color(m_colControlDark.r,
                                                   m_colControlDark.g,
                                                   m_colControlDark.b,
                                                   230));
                m_Render->DrawFilledRect(Gwen::Rect(rect.x + iBorderSize + 1,
                                                    rect.y + topHeight,
                ...
                // Inside border
                m_Render->SetDrawColor(m_colControlOutlineNormal);
                m_Render->DrawLinedRect(Gwen::Rect(rect.x+iBorderSize, rect.y+topHeight-1,
            ...
            virtual void DrawComboDownArrow(Gwen::Controls::Base* control, bool ,
                                            bool , bool , bool )
            {
            ...
            virtual void DrawNumericUpDownButton(Gwen::Controls::Base* control, bool ,
                                                 bool bUp)
            {
                //DrawButton( control->Width(), control->Height(), bDepressed, false, true );
                m_Render->SetDrawColor(Gwen::Color(0, 0, 0, 240));
            ...
            virtual void DrawStatusBar(Controls::Base* )
            {
                // TODO.
            }
            ...
            virtual void DrawCategoryHolder(Controls::Base* ) {}
            virtual void DrawCategoryInner(Controls::Base* , bool ) {}
        };
...
#endif // ifndef GWEN_SKINS_SIMPLE_H
