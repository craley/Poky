    ...
    namespace Skin
    {
        class TexturedBase : public Gwen::Skin::Base
        {
            public:
                ...
                virtual void DrawRadioButton( Gwen::Controls::Base* control, bool bSelected, bool )
                {
                    if ( bSelected )
                    {
                ...
                virtual void DrawCheckBox( Gwen::Controls::Base* control, bool bSelected, bool )
                {
                    if ( bSelected )
                    {
                        if ( control->IsDisabled() )
                ...
                virtual void DrawWindow( Gwen::Controls::Base* control, int, bool inFocus )
                {
                ...
                virtual void DrawScrollBar( Gwen::Controls::Base* control, bool isHorizontal, bool )
                {
                    if ( isHorizontal )
                ...
                virtual void DrawKeyboardHighlight( Gwen::Controls::Base*, const Gwen::Rect & r, int iOffset )
                {
                    Gwen::Rect rect = r;
                    rect.x += iOffset;
                    rect.y += iOffset;
